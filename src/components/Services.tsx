        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="glass-card p-8 rounded-3xl border-white/5">
            <h4 className="flex items-center gap-3 text-xl font-bold mb-6">
              <ShieldCheck className="text-[#a5a58d]" aria-hidden="true" /> Usage & Rights
            </h4>
          ...
          <div className="flex gap-4 p-8 glass-card rounded-3xl border-white/5">
            <div className="w-16 h-16 rounded-2xl bg-[#6b705c]/10 flex items-center justify-center shrink-0">
              <PlayCircle className="text-[#6b705c]" size={32} aria-hidden="true" />
            </div>
            <div>
